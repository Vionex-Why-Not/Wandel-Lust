...
// (Moved to the top so forms work correctly!)
// ==========================================
app.set("view engine","ejs"); 
app.set("views",path.join(__dirname,"views"));
app.engine("ejs",ejsMate);
...
// FIX 1: The Root Route is no longer commented out! 
// This sends users straight to the listings page instead of a "Cannot GET /" error.
app.get("/", (req, res) => {
